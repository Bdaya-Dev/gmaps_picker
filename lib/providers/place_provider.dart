...
class PlaceProvider extends ChangeNotifier {
  ...
  locLoc.LocationAccuracy? desiredAccuracy;
  ...
  Future<void> updateCurrentLocation(bool forceAndroidLocationManager) async {
    ...
    try {
      ...
      if (_permissionGranted == locLoc.PermissionStatus.granted) {
        currentPosition = await locLoc.Location.instance.getLocation();
      } else {
  ...
  locLoc.LocationData? _currentPoisition;
  locLoc.LocationData? get currentPosition => _currentPoisition;
  set currentPosition(locLoc.LocationData? newPosition) {
